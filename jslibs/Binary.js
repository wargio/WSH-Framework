Binary = (function() {
    var bobj = function(name, flags) {
        if (flags == undefined)
            throw new Error('Binary: Invalid flags');
        this.flags = flags;
        this.READ = 0;
        this.WRITE = 1;
        var adTypeBinary = 1
        ...
        if (flags != this.READ && flags != this.WRITE)
            throw new Error('Binary: Invalid flags');
        forward['80'] = '00C7';
        forward['81'] = '00FC';
        forward['82'] = '00E9';
        ...
        this.context = WScript.CreateObject("ADODB.Stream");
        this.context.Type = adTypeText;
        this.context.CharSet = codePage;
        this.context.Open();
        ...
        this.read = function(size) {
            if (this.flags == this.WRITE)
                throw new Error('Cannot read on Write mode.');
            if (size >= 0)
                return this.Backward437(this.context.ReadText(size));
            return this.Backward437(this.context.ReadText());
        };
        this.write = function(what) {
            if (this.flags == this.READ)
                throw new Error('Cannot write on Read mode.');
            this.context.WriteText(this.Forward437(what));
        };
        this.isEOF = function() {
            return this.context.EOS;
        };
        this.d2h = function(d) {
